    ...
    <div className="space-y-6">
      ...
      >
        <form className="space-y-4" onSubmit={submit}>
          ...
          <FieldLabel label="車班名稱" required><input className="field" value={form.routeName} onChange={(event) => setForm({ ...form, routeName: event.target.value })} placeholder="例如：14:00 員工車" required /></FieldLabel>
